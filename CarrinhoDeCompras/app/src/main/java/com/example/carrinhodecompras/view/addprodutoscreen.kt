...
import com.example.carrinhodecompras.UIElements.CreateTextTitle
...
fun generateObject(name:String, price:String, description:String, uid:String?=""):Produto{
    return if(name!=null || price!=null || description!=null ||uid!=null){
        try{
            val priceInt = price.toInt()
            val newProduct = Produto(name,priceInt,description,uid)
            newProduct
        }catch(e:Exception){
            Log.d("AddProductScreen","Ocorreu um erro :${e}")
            Produto("", 0, "", "")
