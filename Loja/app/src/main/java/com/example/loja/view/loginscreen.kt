...
@Composable
fun LoginScreen(navController: NavController, viewModel: RegistoUtilizadorViewModel = viewModel()) {
                ...
                if (loginUtilizador.isNullOrEmpty() || passwordUtilizador.isNullOrEmpty()) {
                    ...
                    try {
                        viewModel.viewModelScope.launch {
                            val resultLogin = viewModel.createAccount(loginUtilizador, passwordUtilizador)
                            if (resultLogin) {
